...
void FpCamera::Update(double dt)
{
	...
	if (Application::IsKeyPressed('A'))
	{
		...
		if (position.x - right.x < -50 || position.x - right.x > 50)
		{
			if (position.z - right.z < -50 || position.z - right.z > 50)
			{
			}
			else
			{
		...
		else if (position.z - right.z < -50 || position.z - right.z > 50)
		{
			if (position.x - right.x < -50 || position.x - right.x > 50)
			{
			}
	...
	if (Application::IsKeyPressed('W'))
	{
		...
		if (position.x + view.x < -50 || position.x + view.x > 50)
		{
			if (position.z + view.z < -50 || position.z + view.z > 50)
			{
			}
			else
			{
		...
		else if (position.z + view.z < -50 || position.z + view.z > 50)
		{
			if (position.x + view.x < -50 || position.x + view.x > 50)
			{
			}
